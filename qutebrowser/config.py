...
#     "~/.dotfiles/solarized-everything-css/css/solarized-light/solarized-light-all-sites.css"
# ]
...
c.url.start_pages = ['start.duckduckgo.com']
...
# Make it feel more like a Mac App
...
config.bind('<Meta-o>', 'set-cmd-text -s :open')
...
config.bind('<Meta-,>', 'open -t qute://settings')

for n in range(1, 8):
    config.bind('<Meta-' + str(n) + '>', 'tab-focus ' + str(n))

# Toggle light, dark mode
# config.bind('<F4>', 'config-cycle content.user_stylesheets ~/.dotfiles/solarized-everything-css/css/solarized-light/solarized-light-all-sites.css "" ;; reload')
# config.bind('<F5>', 'config-cycle content.user_stylesheets ~/.dotfiles/solarized-everything-css/css/solarized-dark/solarized-dark-all-sites.css "" ;; reload')
...
# config.bind('o', 'set-cmd-text -s :open', mode='command')
